...
20. **Done:** scaffold, docs, provenance, and automation exist, including SwiftPM tests plus macOS app-assembly, plist-substitution, and signing checks. Product-specific UI and release acceptance remain the responsibility of each derived application.
